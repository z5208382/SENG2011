...
method tester()
{
  var a: array<int> := new int[] [1, 42, 0, 0, 0, 0, 0, 0, 0, 0, 0];
  assert a[0] == 1 && a[1] == 42 && a[2] == 0 && a[3] == 0 && a[4] == 0 && a[5] == 0;
  assert exist1(a, 0);
}
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      BigInteger[] _24_a;
      BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(Dafny.Helpers.ToIntChecked(new BigInteger(11), "C# arrays may not be larger than the max 32-bit integer"),"C# array size must not be larger than max 32-bit int")];
      _nw0[(int)(0)] = BigInteger.One;
      _nw0[(int)(1)] = new BigInteger(42);
      _nw0[(int)(2)] = BigInteger.Zero;
      _nw0[(int)(3)] = BigInteger.Zero;
      _nw0[(int)(4)] = BigInteger.Zero;
      _nw0[(int)(5)] = BigInteger.Zero;
      _nw0[(int)(6)] = BigInteger.Zero;
      _nw0[(int)(7)] = BigInteger.Zero;
      _nw0[(int)(8)] = BigInteger.Zero;
      _nw0[(int)(9)] = BigInteger.Zero;
      _nw0[(int)(10)] = BigInteger.Zero;
      _24_a = _nw0;
    }
  }
